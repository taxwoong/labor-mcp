...
# tools/list에 반드시 있어야 하는 도구 — 25종 전부를 검사한다.
...
EXPECTED_TOOLS = {
    ...
    "moel_counsel_search", "social_insurance_decision_search", "labor_archive_search",
    ...
    "calc_social_insurance", "check_premium_support",
